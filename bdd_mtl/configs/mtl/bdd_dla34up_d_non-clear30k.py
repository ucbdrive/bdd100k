...
cfg.work_dir = './work_dirs/debug/BDD-d_non-clear-30k/dla34up'
cfg.load_from = None
cfg.resume_from = None
cfg.data['train'][0]['ann_file'] = cfg.data['train'][0]['ann_file'][:-5] + '_non-clear_30k.json'
cfg.data['test'][0]['ann_file'] = cfg.data['val'][0]['ann_file'][:-5] + '_non-clear.json'
